...
<div class="row">
      ...
      <div class="col-lg-4">
        ...
        <card>
          ...
          <table>
            <tr><td colspan="2"><img src="img/temperature.png" style="width: 25px;"><p>Termometr: DHT11</p></td></tr>
            <tr>
              <td><p style="font-size: 30px; color: #1df8ca;"> {{ temperature }} &#8451; </p></td>
              <td><p style="font-size: 30px; color: #1d8af8;"> {{ humidity }} % </p></td>
            </tr>
            <tr><td colspan="2"><img src="img/temperature.png" style="width: 25px;"><p>Termometr: DS18B20</p></td></tr>
            <tr>
